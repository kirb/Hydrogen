...
#End Region
    ...
    'Private Sub buttonTwitter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    '    ieBrowser.Url = New Uri("https://twitter.com")
    'End Sub
    ...
    Private Sub textboxAddress_Leave() Handles textboxAddress.Leave
        'textboxAddress.BackColor = Color.Transparent
    End Sub
    ...
    '    info.Arguments = e.ToString() 'ieBrowser.Url.ToString()
    '    Process.Start(info)
    '    e.Cancel = True
    'End Sub
End Class
...
Public Class OrientedTextLabel
    ...
    Public Property RotationAngle() As Double
        ...
        End Set
    End Property
    <Description("Direction of the Text"), Category("Appearance")> _
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Dim width As Single = graphics.MeasureString(m_text, Me.Font).Width
        Dim height As Single = graphics.MeasureString(m_text, Me.Font).Height
        ...
        graphics.DrawString(m_text, Me.Font, textBrush, 0, 0)
        graphics.ResetTransform()
    End Sub
End Class

Public Class textboxAddress
    Inherits TextBox
...
Public Class toolstripMenu 'NonClientAreaRenderer
